...
public class ArrayOfInts {
	 ...
	 * 
	 * @param size number of elements in returned array
	 * @param repetitions duplication rate: e.g. if 2, expect minimum 2 of each value in the array
	 *            (may be 3 of some)
	...
	/**
	 * Writes an int[] to a plain-text file with ints separated by spaces. Useful for creating input
	 * files for repeatable tests.
	 * 
